...
![](https://resource-1256956499.cos.ap-beijing.myqcloud.com/img/20190419113114.png)
...
![](https://resource-1256956499.cos.ap-beijing.myqcloud.com/img/20190425173008.png)

### TCP四次挥手过程

![](https://resource-1256956499.cos.ap-beijing.myqcloud.com/img/20190425174717.png)
...
**本章记忆性内容多 间隔记忆 多次重复 检所学习 穿插练习**

* 费曼学习技巧 用简单语言去交别人 检验自己是否真正的懂了
* 假设一个完全不懂这些概念的人 你如何用自己的话解释这个概念
* 如果解释过程中遇到阻碍 重新学习这个知识点
...
* 索引是数据表中一个或者多个列进行排序的数据结构(B+Tree)
* 索引能够大幅提升检索速度
* 创建、更新索引本身也会浪费时间和空间
...
* 二叉查找树：插入和查询很快(logn)；无法寸大规模数据，复杂度退化
* 平衡树：解决bst退化问题，树是平衡的；节点非常多的时候，依然树高很高
* 多路查找树：一个父亲多个孩子节点(度)；节点过多不会特别深
* 多路平衡查找树：B-Tree
...
![](https://resource-1256956499.cos.ap-beijing.myqcloud.com/img/20190419164823.png)
